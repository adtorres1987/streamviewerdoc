...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            User user, String token, Subscription? subscription)
        authenticated,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(User user, String token, Subscription? subscription)?
        authenticated,
...
abstract class _$$AuthAuthenticatedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({User user, String token, Subscription? subscription});
...
class _$AuthAuthenticatedImpl implements AuthAuthenticated {
  const _$AuthAuthenticatedImpl(
      {required this.user, required this.token, this.subscription});
  ...
  @override
  String toString() {
    return 'AuthState.authenticated(user: $user, token: $token, subscription: $subscription)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, user, token, subscription);
  ...
  TResult when<TResult extends Object?>({
    ...
    return authenticated(user, token, subscription);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return authenticated?.call(user, token, subscription);
  }
...
abstract class AuthAuthenticated implements AuthState {
  const factory AuthAuthenticated(
      ...
      final Subscription? subscription}) = _$AuthAuthenticatedImpl;
